	...
	public void achievementsTest(){
		System.setProperty("webdriver.gecko.driver", "C:\\Users\\User\\Desktop\\Selnium_Repos"
               ...
               driver.findElement(By.xpath("//*[@id='menu-item-783']/a")).click();
				...
				driver.findElement(By.xpath("//*[@id='menu']/ul/li[2]/ul/li[4]/a")).click();
				
				driver.findElement(By.xpath("html/body/section/div/section/div/div/section/div/table/tbody/tr[1]/td[5]/button")).click();
				
				System.out.println("Check the Achievements");
	}
